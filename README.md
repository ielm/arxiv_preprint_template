...
A simple LaTeX template suitable for "preprint" publications such as arXiv and bio-arXiv, etc. 
...
2. **main.tex** - a sample template that uses the **arxiv style**.
...
A 2 column template can be found in https://github.com/brenhinkeller/preprint-template.tex.
